...
insert into person (name,description,a_number) values ('Mr.Carrot', 'the Carrot',   23);
insert into person (name,description,a_number) values ('Mr.Pear'  , 'the Pear'  ,   65);
insert into person (name,description,a_number) values ('Mr.Apricot', 'the Apricot', 34);
